package cz.grossik.projektwow.wizard.entity;
...
public class EntityFire extends EntityFireball
{
    ...
    public EntityFire(World p_i1767_1_)
    {
        super(p_i1767_1_);
    }

    @SideOnly(Side.CLIENT)
    public EntityFire(World p_i1768_1_, double p_i1768_2_, double p_i1768_4_, double p_i1768_6_, double p_i1768_8_, double p_i1768_10_, double p_i1768_12_)
    {
        super(p_i1768_1_, p_i1768_2_, p_i1768_4_, p_i1768_6_, p_i1768_8_, p_i1768_10_, p_i1768_12_);
    }

    public EntityFire(World p_i1769_1_, EntityLivingBase p_i1769_2_, double p_i1769_3_, double p_i1769_5_, double p_i1769_7_)
    {
    ...
    protected void onImpact(MovingObjectPosition p_70227_1_)
    {
        ...
        if (!this.worldObj.isRemote)
        {
            if (p_70227_1_.entityHit != null)
            {
                ...
                p_70227_1_.entityHit.setFire(100);
            }
            this.setDead();
        }
    }
