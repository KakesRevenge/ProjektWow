package cz.grossik.projektwow.warrior.entity;
...
public class EntityWoodenSpear extends Entity implements IProjectile
{
    ...
    public EntityWoodenSpear(World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_)
    {
        super(p_i1756_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public void onCollideWithPlayer(EntityPlayer p_70100_1_) {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0) {
            ...
            if (this.canBePickedUp == 1 && !p_70100_1_.inventory.addItemStackToInventory(new ItemStack(ItemHandler.WoodenSpear, 1)))
            {
                flag = false;
            }
    ...
    public static DamageSource causeArrowDamage(EntityWoodenSpear spear, Entity entity) {
        return (new EntityDamageSourceIndirect("woodenspear", spear, entity)).setProjectile();
    }
}